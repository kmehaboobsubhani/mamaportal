...
export class LocksComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.service.getLocks(this.masterLockerId).subscribe((resp: any) => {
      console.log("getLocks Reponse:::" + JSON.stringify(resp));
      if (resp && resp.statusCode == 200) {
        console.log("Locks...............................")
        this.locks = resp.locks;
        this.spinner.hide();
      }
    });
  }
  ...
  updateSpring() {
    ...
    this.service.loadItemsOfSpring(spr).subscribe((resp: any) => {
      ...
      if (resp && resp.status == 200) {
       // console.log("Locks...............................");
        this.locks.forEach(sp => {
          console.log(">>>>>>>>>"+JSON.stringify(sp))
          let spr = sp.locks.find(s => s.springName == this.springName);
          if(spr) {
