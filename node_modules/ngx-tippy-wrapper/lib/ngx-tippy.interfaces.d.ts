...
export declare type NgxTippyContent = Content;
export interface NgxHideAllOptions {
    duration?: number;
    excludeName?: string;
}
export declare type InstanceChangeReason = 'setInstance' | 'show' | 'hide' | 'hideWithInteractivity' | 'disable' | 'enable' | 'setProps' | 'setContent' | 'setTriggerTarget' | 'unmount' | 'clearDelayTimeouts' | 'destroy';
