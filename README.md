...
[![NPM downloads][npm-coreui-angular-download]][npm-coreui-angular] [![npm-coreui-angular-next][npm-coreui-angular-next]][npm-coreui-angular]  
...
![angular](https://img.shields.io/badge/angular-^11.0.5-lightgrey.svg?style=flat-square&logo=angular)  
...
## CoreUI Pro 3 Angular 11 Admin Template `v3-alpha`
...
###### Node.js
Angular 11 requires `Node.js` version 12 or later.
