(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-inventory-items-items-module"], {
    ...
    /***/
    function lv(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_items_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./items.component.html */
      "wieO");
      /* harmony import */


      var _items_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      /*! @angular/router */
      "iInd"); //import { ValidationFormsService } from './validation-forms.service';


      var DataTablesComponent = /*#__PURE__*/function () {
        function DataTablesComponent(fb, service, commonData, spinner, router) {
          var _this = this;
          ...
          this.createForm();
          this.setTab = 0;
          this.service.getAllItemsOfMerchant(this.commonData.merchantId).subscribe(function (data) {
            setTimeout(function () {
              _this.data = _toConsumableArray(data); //Refresh
            }, 1000);
          }, function (error) {
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _service_data_service__WEBPACK_IMPORTED_MODULE_6__["DataService"], _Common_common_data_service__WEBPACK_IMPORTED_MODULE_5__["CommonDataService"], ngx_spinner__WEBPACK_IMPORTED_MODULE_7__["NgxSpinnerService"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"]])], DataTablesComponent);
      /***/
    },
    ...
    /***/
    function K3aW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Kopg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _items_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./items.component */
      "10lv");
      /* harmony import */


      var _items_filter_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./items-filter.pipe */
      "K3aW");
      /* harmony import */
    ...
    /***/
    function Y8rU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function f3ut(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function wieO(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=views-inventory-items-items-module-es5.js.map